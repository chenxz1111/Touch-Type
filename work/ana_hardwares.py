...
# work_book = xlrd.open_workbook('Ahardwares.xlsx')
# wb = op.load_workbook("Ahardwares.xlsx")
# sh=wb["Sheet1"]
...
#     id += 1
# wb.save("Ahardwares.xlsx")

#显著性分析

import pingouin as pg
import pandas as pd
Fpath = './Ahardwares.xlsx'
df = pd.read_excel(Fpath)
data = df.dropna()


aov = pg.rm_anova(dv='accuracy', within=['hardwares'], 
